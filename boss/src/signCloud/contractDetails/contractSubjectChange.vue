    ...
    <div class="sign-confirm">
        <div v-if="contractInfo.contractAgrement.status=='NONE' && contractInfo.agrementApprovalVo" style="width: 100%;border-bottom: 1px;border: #f9cd89;height: 50px;background-color: #fffdec;font-size: 14px;line-height: 50px;color: #c5652a">
            ...
            <div class="reject-contract">
                <p>甲方：{{contractInfo.signedContractName}}</p>
            </div>
        </div>
        <Form ref="form" :model="contractInfo" :rules="ruleValidate" :label-width="80" label-position="left">
            <Row class="subject-info">
                ...
                <i-col span="11" class="partner" v-if="contractInfo.subjectList.length > 2">
                    <Card :bordered="false" :dis-hover="true" :padding="20">
                        ...
                        <Row>
                            <i-col span="13">
                                <Form-item label="联系人：" prop="subjectList[2].contactName" class="contact-name-error">
                            ...
                            <i-col span="10" offset="1">
                                <Form-item :label-width="1" prop="subjectList[2].contactPhone" class="contact-phone-error">
                                    <Tooltip v-if="!isEdited" :content="contractInfo.subjectList[2].contactPhone" class="tips" placement="bottom">
                                        <Input class="word-filters" v-model="contractInfo.subjectList[2].contactPhone" placeholder="联系人电话" :maxlength="11" :disabled="!isEdited"/>
                                    </Tooltip>
                                    <Input v-else v-model="contractInfo.subjectList[2].contactPhone" placeholder="联系人电话" :maxlength="11" :disabled="!isEdited"/>
                                </Form-item>
                            </i-col>
                        </Row>
                        <Form-item label="邮箱：">
                    ...
                    <Card :bordered="false" :dis-hover="true" :padding="20">
                        ...
                        <div>
                            ...
                            <Form-item :label-width="1" prop="oldSignedDate" style="display: inline-block;line-height: 30px;">
                                <DatePicker :disabled="true" class="input150" placeholder="选择日期" v-model="contractInfo.oldSignedDate"></DatePicker>
                            </Form-item>
                            <span>共同签署了</span>
                            <Form-item prop="signedContractName" :label-width="1" style="display: inline-block;line-height: 30px;">
                                <Tooltip :content="contractInfo.signedContractName" class="tips" placement="bottom">
                        ...
                        <div>
                            ...
                            <Form-item prop="signedContractContent" :label-width="1" style="display: inline-block;line-height: 30px;">
                                <Tooltip :content="contractInfo.signedContractContent" class="tips" placement="bottom">
                        ...
                        <div class="change-items">
                            ...
                            <ul>
                                <li>
                                    <img src="./image/change-item-1.png">
                                    <div>
                                ...
                                <li>
                                    <img src="./image/change-item-2.png">
                                    <div>
                                ...
                                <li>
                                    <img src="./image/change-item-3.png">
                                    <div>
                                        <input value="乙方" :disabled="true">
                                        <span>基于原合同对</span>
                                        <input value="甲方" :disabled="true">
                                ...
                                <li>
                                    <img src="./image/change-item-4.png">
                                    <div>
                                        <input value="甲方" :disabled="true">
                                ...
                                <li>
                                    <img src="./image/change-item-5.png">
                                    <div>
            ...
            <div class="button-area" v-if="isEdited">
                <div>
                    <!--<Button type="ghost" size="large" class="save-button" @click="cancel">取消</Button>-->
                    <Button type="primary" size="large" class="audit-button" @click="save">提交审核</Button>
                </div>
            </div>
        </Form>
    </div>
            ...
            return {
                ...
                ruleValidate: {
                    ...
                    'subjectList[2].contactName': [
                        {required: true, message: '丙方联系人不能为空', trigger: 'blur'},
                        {max: 20, message: '丙方联系人不允许超过20字符'},
                    ],
                    'subjectList[2].contactPhone': [
                        {required: true, message: '丙方联系电话不能为空', trigger: 'blur'},
                        {pattern:  /^[0-9]*$/ ,message:'请输入正确的联系电话'},
                        {max: 11, message: '丙方联系电话不允许超过11字符'},
                    ],
//                    'subjectList[2].email': [
                ...
                this.$refs['form'].validate(valid => {
                    if (valid) {
                        this.request({
                            ...
                            this.$api.apiChangeSubmit(this.contractInfo.signedContractId);
                        });
                    }
                });
            }
