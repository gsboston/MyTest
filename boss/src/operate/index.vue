...
<script>
    import Vue from "vue";
    import "./router";
    const ROUTER_STATUS = "report_router_status";
    ...
    export default {
        ...
        methods: {
            getMenuList () {
                ...
                this.moduleCode = location.href.substring(index + 2, end > -1 ? end : null);
                this.request({
...
//                        this.currentCode = items[0].funcCode;
//                    }
                });
            },
            open (item) {
            ...
            _open () {
                ...
                if(param.funcCode) {
                    ...
                    if(param.prop) {
                        ...
                        if(func.init) {
                            func.init.call(func, param.props);
                        }
                    }
                }
            }
