        ...
        data () {
            return {
                ...
                tableColumns: [{
                    ...
                    }},{title: '用户类型',key: 'permissionLevel', align: 'center' , render: (h, params) => {
                        if(params.row.permissionLevel=='SUPER_SYSTEM_LEVEL'){
                            return '超级管理员';
                        }
                        if(params.row.permissionLevel=='SYSTEM_LEVEL'){
                            return '系统管理员';
                        }
                        if(params.row.permissionLevel=='ORGANIZATION_LEVEL'){
                            return '机构管理员';
                        }
                        if(params.row.permissionLevel=='GENERAL_USER_LEVEL'){
                            return '普通用户';
                        }
                    }
                }]
