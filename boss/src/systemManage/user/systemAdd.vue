        ...
        <Form :model="formItem" :label-width="80" inline :rules="ruleInline" ref="formItem"  >
            ...
            <i-col span="11">
                <Form-item label="权限级别" prop="postLevel">
                    <Select v-model="formItem.postLevel" disabled>
                        <Option value="SYSTEM_LEVEL">系统管理员</Option>
                    </Select>
                </form-item>
            </i-col>
        ...
        methods: {
            addSubmit(name) {
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        this.request({
                            url: "/systemManage/superUser/saveUser.do",
                            data: {
...
//                        this.$Message.error('表单验证失败!');
        ...
        created:function(){
            this.formItem.postLevel = 'SYSTEM_LEVEL'
        }
    }
</script>
