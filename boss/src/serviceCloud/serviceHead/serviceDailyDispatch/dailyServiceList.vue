                            ...
                            <div style="padding: 5px 0 5px 0">
                                ...
                                <div class="service-item-saleOrgName" style="display: inline-block;width: 250px;font-weight: bold;margin-left: 20px">
                                    <Tooltip placement="top">
                                        ...
                                        <div slot="content">
                                            <p>联系人：{{serviceInfo.linkname}}</p>
                                            <p>联系电话：{{serviceInfo.linkphone}}</p>
                                            <p>地址：{{serviceInfo.address}}</p>
                                        </div>
                                    </Tooltip>
                                </div>
                                ...
                                <div style="display: inline-block;width: 450px;margin-left: 20px;" :title="serviceInfo.saleOrgName">
                                ...
                                <div v-if="dealWithState=='ALREADY_RECEIVE'" class="again-dispatching">
                                    <Button v-if="serviceInfo.service_state != 'FINISHED'" type="ghost" @click="singleDealWith(serviceInfo)">重新派工</Button>
    ...
    export default {
        ...
        data () {
            return {
                ...
                dealWithState: "ALREADY_RECEIVE",//ALREADY_RECEIVE    NONE_RECEIVE
                searchText: null,
                saleOrg: null,
                serviceType: null,
        ...
        methods:{
            dealWith (dealWithState) {
                ...
                if(dealWithState == "ALREADY_RECEIVE"){
                    this.isAll = false;
